...
class BaseApi(api_client.Api):
    ...
    def _get_all_profiles_mapped_args(
        self,
    ) -> api_client.MappedArgs:
        args: api_client.MappedArgs = api_client.MappedArgs()
        return args

    async def _aget_all_profiles_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/v1/admin/profiles',
            auth_settings=_auth,
            headers=_headers,
        )
...
class GetAllProfilesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_all_profiles(
        self,
        **kwargs,
    ) -> typing.Union[
        ApiResponseFor200Async,
        ...
        args = self._get_all_profiles_mapped_args(
        )
        return await self._aget_all_profiles_oapg(
            **kwargs,
        )
    ...
    def get_all_profiles(
        ...
        return self._get_all_profiles_oapg(
        )

class GetAllProfiles(BaseApi):
    ...
    async def aget_all_profiles(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_all_profiles(
            **kwargs,
        )
        if validate:
    ...
    def get_all_profiles(
        ...
        raw_response = self.raw.get_all_profiles(
        )
        if validate:
            return ProfilesGetAPIResponseDTOPydantic(**raw_response.body)
        return api_client.construct_model_instance(ProfilesGetAPIResponseDTOPydantic, raw_response.body)
