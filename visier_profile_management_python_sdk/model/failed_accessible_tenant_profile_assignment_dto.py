...
class FailedAccessibleTenantProfileAssignmentDTO(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["userId", "tenantCode", "forAllChildren", "error", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["userId", "tenantCode", "forAllChildren", "error", ], str]):
