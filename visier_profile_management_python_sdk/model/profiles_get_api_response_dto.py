...
class ProfilesGetAPIResponseDTO(
    schemas.DictSchema
):
    """
        ...
        class properties:
            ...
            class profiles(
                ...
                class MetaOapg:
                    ...
                    @staticmethod
                    def items() -> typing.Type['ProfileGetAPIResponseDTO']:
                        return ProfileGetAPIResponseDTO
            
                def __new__(
                    cls,
                    arg: typing.Union[typing.Tuple['ProfileGetAPIResponseDTO'], typing.List['ProfileGetAPIResponseDTO']],
                ...
                def __getitem__(self, i: int) -> 'ProfileGetAPIResponseDTO':
