...
class TargetTenantCodeDTO(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["tenantCode", "forAllChildren", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["tenantCode", "forAllChildren", ], str]):
